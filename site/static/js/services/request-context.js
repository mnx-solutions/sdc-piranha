    ...
    app.service('requestContext',[
        ...
        function (RenderContext) {
            ...
            function getRenderContext(requestActionLocation, paramNames) {
                ...
                // of names. If a single name was provided,
                // let's convert it to the array.
            ...
            function setUpRenderContext(requestActionLocation, scope, opts) {
                ...
                // Update window title
                if (opts) {
                    if (opts.title && scope.setWindowTitle) {
                        scope.setWindowTitle(opts.title);
                    }
                }
            ...
            function hasParamChanged(paramName, paramValue) {
                ...
                // If the param value exists,
                // then we simply want to use that to compare
            ...
            function haveParamsChanged(paramNames) {
                var i, length;
                for (i = 0, length = paramNames.length; i < length; i++) {
            ...
            function startsWith(prefix) {
                ...
                // When checking, we want to make sure we don't
                // match partial sections for false
                // positives. So, either it matches in entirety;
                // or, it matches with an additional dot at the end.
                if (!prefix.length ||
                    (action === prefix) ||
