  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      return function(scope, element, attrs, ctrls, transcludeFn) {
        ...
        function setCorrectPosition() { //  TODO update library when following issue will be fixed, https://github.com/angular-ui/ui-select/issues/1250
        ...
        if (appendToBody !== undefined ? appendToBody : uiSelectConfig.appendToBody) {
          //TODO update library when following issue will be fixed, https://github.com/angular-ui/ui-select/issues/1254
          var wnd = angular.element(window);
          var modalHeader = angular.element('.modal-header');
          var modalBody = angular.element('.modal-body');
          var modalFooter = angular.element('.modal-footer');
          var modalContent = angular.element('.modal-content');
          ...
          var isOutside = function () {
            ...
            return modalTop + modalHeader.outerHeight() > selectTop ||
              modalTop + modalContent.height() - modalFooter.outerHeight() < selectTop + element.height();
          };
