...
var mktoMunchkin = Munchkin.init;
var mktoMunchkinDebug = Munchkin.debug;
var mktoMunchkinFunction = Munchkin.munchkinFunction;
var _MchSingle = {
    capable: false,
    inited: false,
    id: null,
        ...
        if (this.inited) {
            ...
            if (_MchHlpr.isDefined(b.id) || this.cookieAnon || a) {
                ...
                if (b.token == null) b.token = this.visitorToken != null && this.visitorToken != "VISITOR_MKTTOK_REPLACE" ?
                        this.visitorToken : _MchHlpr.generateToken(this.domain);
